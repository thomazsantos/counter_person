...
while True:
    ...
    cv2.line(frame, (0, fH // 2), (fW, fH // 2), (0, 255, 255), 2)
    ...
    for (objectID, centroid) in objects.items():
        ...
        if to is None:
            ...
            if not to.counted:
                ...
                if direction < 0 and centroid[1] < fH // 2:
                    totalUp += 1
                    to.counted = True

                elif direction > 0 and centroid[1] > fH // 2:
                    totalDown += 1
                    to.counted = True
    ...
    info = [("Saida", totalUp),("Entrada", totalDown),("Status", status),]
